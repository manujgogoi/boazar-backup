# Generated by Django 3.1.7 on 2021-04-01 01:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.IntegerField(blank=True, help_text='Optional', null=True, verbose_name='Quantity')),
                ('wholesale_quantity', models.IntegerField(blank=True, help_text='Optional', null=True, verbose_name='Wholesale Quantity')),
                ...
                ('wholesale_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 99999.99'}}, help_text='Maximum 99999.99', max_digits=7, verbose_name='Wholesale Price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Required', max_length=255, verbose_name='Spec. Name')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='images/products/default.png', help_text='Upload a product image', upload_to='images/products/', verbose_name='image')),
